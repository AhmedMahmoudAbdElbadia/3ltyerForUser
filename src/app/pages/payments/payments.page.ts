...
export class PaymentsPage implements OnInit {
  ...
  async ngOnInit() {
    ...
    console.log("هنا ",this.deliveryCharge)
...
if(localStorage.getItem("MarketFlage")=="true"){
      ...
      this.vid = "04bUaRuqfhXEjAcFCOxn4LqsqdF3";
...
this.quan=parseInt(realsItems.quantiy)
...
subPrice = subPrice + (parseInt(realsItems.quantity) * realsItems.value);
   ...
   // this.deliveryCharge = 5;
    ...
    console.log("quan+grandtotal"+this.quan+""+this.grandTotal)
    if (this.totalItem === 0) {
