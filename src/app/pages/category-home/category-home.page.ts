...
//  this.nearLocation();
 ...
 else if (item.id=='403011321'){
  this.flagPharmcy="Pharmcy";
  const navData: NavigationExtras = {
 queryParams: {
   id: item.id,
   flag:this.flagPharmcy
 }
};
