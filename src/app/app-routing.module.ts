...
const routes: Routes = [
  ...
  {
    path: 'pharmacyorder',
    loadChildren: () => import('./pharmacyorder/pharmacyorder.module').then( m => m.PharmacyorderPageModule)
  },
  {
    path: 'pharmacyorderdetails',
    loadChildren: () => import('./pharmacyorderdetails/pharmacyorderdetails.module').then( m => m.PharmacyorderdetailsPageModule)
  }
];
@NgModule({
  imports: [
