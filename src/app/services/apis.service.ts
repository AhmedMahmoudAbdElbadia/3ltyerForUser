...
result.confirm(code).then(function (result) {
...
.catch (error => {
  ...
  public getCategories(): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('restaurantcategories').get().subscribe((cat: any) => {
        let data = cat.docs.map(element => {
          let item = element.data();
          item.id = element.id;
          return item;
        });
...
public CreatPharmacyOrder(id, param){
  ...
  public register(email: string, password: string, fullname: string,PhoneNum:string): Promise<any> {
    return new Promise<any>((resolve, reject) => {
  ...
  public getVenues(cat?): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      if (cat) {
        this.adb.collection('venue', ref => ref.where('category', '==', cat)).get().subscribe((venue) => {
          let data = venue.docs.map(element => {
            let item = element.data();
            item.id = element.id;
            return item;
  ...
  public getSection(): Promise<any> {
    return new Promise<any>((resolve, reject) => {
     
     
        this.adb.collection('section').get().subscribe((section) => {
          console.log("Section Api",section)
          let data = section.docs.map(element => {
            let item = element.data();
            item.id = element.id;
            return item;
          });
  ...
  public getSectionDetails(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('section').doc(id).get().subscribe((venue: any) => {
        resolve(venue.data());
      }, error => {
        reject(error);
      });
  ...
  public getVenueDetailsBySection(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('venue').doc(id).get().subscribe((venue: any) => {
        resolve(venue.data());
      }, error => {
  ...
  public getSectionCategories(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('sectioncategories', ref => ref.where('sectionid', '==', id)).get().subscribe((sectioncategories) => {
        var data = sectioncategories.docs.map(element => {
          var item = element.data();
          item.id = element.id;
          return item;
        })
  ...
  public getSectionProd(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      // this.db.collection('sectionprod').doc(id).collection('all').get().then((data) => {
      //   var users = data.docs.map(doc => {
      //     var item = doc.data();
      //     item.cid.get().then(function (doc) {
      //       item.cid = doc.data();
      ...
      //   reject(error);
      // });
      this.adb.collection('sectionprod', ref => ref.where('sectionid', '==',id)).get().subscribe(getSectionProd => {
          
           var data = getSectionProd.docs.map(element => {
      
          var item = element.data();
          item.id = element.id;
          return item;
        })
        console.log("elementsectionpro",data) 
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  public getAllSectionProd(): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      // this.db.collection('sectionprod').doc(id).collection('all').get().then((data) => {
      //   var users = data.docs.map(doc => {
      //     var item = doc.data();
      ...
      //   reject(error);
      // });
      this.adb.collection('sectionprod').get().subscribe(getSectionProd => {
    ...
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('orders', ref => ref.where('userId', '==',id)).get().subscribe(async (venue) => {
        let data = venue.docs.map(element => {
          ...
          let item = element.data();
          console.log(item,"ItEm22232312312")
  ...
  public getPharmacyOrders(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('orderpharmacy', ref => ref.where('userId', '==',id)).get().subscribe(async (venue) => {
        let data = venue.docs.map(element => {
 ...
 public getPharmacyOrderById(id): Promise<any> {
    return new Promise<any>(async (resolve, reject) => {
      this.adb.collection('orderpharmacy').doc(id).get().subscribe(async (order: any) => {
        let data = await order.data();
        // await data.vid.get().then(function (doc) {
        //   data.vid = doc.data();
        //   data.vid.id = doc.id;
